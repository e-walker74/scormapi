        ...
        if (lms.hasOwnProperty("interactions")) {
            if (lms.interactions.length > 0) {
                for (i=0; i<lms.interactions.length; i++) {
                    ...
                    if (lmsinter.hasOwnProperty("student_response")) {
                        inter.learner_response = lmsinter.student_response;
                    }
...
cmi._seconds_to_timeinterval = function(sec) {
